...
public class LogInServlet extends HttpServlet {
	...
	private void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		Gson gson = new Gson();
		Employee employeeData = gson.fromJson(jsonData, Employee.class);
		System.out.println(employeeData);
		Integer id = employeeData.getEid();
		...
		System.out.println("Employee Data from db: "+ data);
		if(data != null)
		{
			String dbEmail = data.getEmail();
