<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    //"wait?result="+flag+"&msisdn=" + ani+"&ref="+ref
                    ...
                    <div class="col-md-7 col-lg-6 col-xl-6 py-3">
                        <div class="inner_content text-center px-3 py-4 p-md-5 bg-white rounded">
                            ...
                            if(result.equalsIgnoreCase("TRUE"))
                            {
                                ...
                                <button onclick="window.location.href='login?msisdn=<%=ani%>&type=offnet'" class="btn w-100 px-4 btn-block text-uppercase btn-primary submit-btn-cus" >Try Again</button>
                            </div>
